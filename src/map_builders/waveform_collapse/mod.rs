...
/// Provieds a map builder using the Wave Function Collapse algorithm.
...
impl WaveformCollapseBuilder {
    ...
    /// * derive_from - ether None or a boxed MapBulder, as output by 'random_builder'
    ...
    /// * derive_from - either None, or a boxed MapBuilder, as output by 'Random builder
