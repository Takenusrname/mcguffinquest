use super::{Map, MapBuilder, Rect, apply_room_to_map, TileType, Position, spawner, SHOW_MAPGEN_VISUALIZER};
...
impl BspDungeonBuilder {
    ...
    fn add_subrects(&mut self, rect: Rect) {
        let width: i32 = i32::abs(rect.x1 - rect.x2);
        let height: i32 = i32::abs(rect.y1 - rect.y2);
        let half_width: i32 = i32::max(width / 2, 1);
        let half_height: i32 = i32::max(height / 2, 1);
